...
export default function EmployeeManagement() {
  const [activeTab, setActiveTab] = React.useState<"directory" | "pto" | "performance">("directory");
      ...
      {activeTab === "directory" && (
        <div className="bg-white rounded-2xl border border-neutral-200 shadow-sm overflow-hidden">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-neutral-500">{staff.id}</p>
                        </div>
                      </div>
                    </td>
          ...
          <div className="px-6 py-4 border-t border-neutral-100 bg-neutral-50/50 flex items-center justify-between">
            <p className="text-sm text-neutral-500">Showing 10 of 286 employees</p>
